...
## Done
- devf context에 git 변경 요약(Recent Changes), 코드 구조(Code Overview) 섹션 추가
...
- devf init으로 프로젝트에 .ai/ 세팅, goals.yaml 작성
...
## Changed Files
- src/devf/utils/codetools.py (신규, +206)
- src/devf/utils/git.py (+51)
- src/devf/core/context.py (+69)
- src/devf/core/auto.py (+35)
...
3. devf auto --dry-run이 dirty tree에서도 동작하도록
4. context.py 452줄 → 리팩토링으로 400줄 이하로

## Context Files
1. src/devf/utils/codetools.py
2. src/devf/core/context.py
3. src/devf/core/auto.py
